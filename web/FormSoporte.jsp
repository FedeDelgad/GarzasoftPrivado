...
<html>
    <head>
        ...
        <title>Garzasoft/ProjectSoporte</title>
    </head>
    <body>
        <div class="container mt-4">
            <div class="d-inline h4 ma-1 pl-2">Agregue el proyecto de soporte</div>
            <hr class="mt-4" style="background: #1f618d" />
            <div class="card">
                <form action="controladorsoporte?accion=agregar" method="post">
                    <div class="card-body">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6 d-flex">
                                ...
                                <div class="modal fade" id="cliente" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header bg-primary text-white">
                                                <h5 class="modal-title" id="staticBackdropLabel">Listar de Clientes</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label>Agregue la descripcion de la actividad de soporte</label>
                                <input type="text" class="form-control" name="actividad" required="true">
                            </div>
                        </div>
                    </div>
