...
<html>
    ...
    <body>     
        <div class=" cuerpo pl-4 pr-4 pt-4 pb-2 " >
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content col-sm-11 p-0">
                        <div class="modal-header mod-h p-3 ">
                            <h4 class="modal-title  text-white mt-4 mb-2 ml-3  " id="exampleModalLabel"><i class="fas fa-user"></i> Nuevo Trabajador</h4>
            ...
            <a href="controladortrabajador?accion=listar" class="btn btn-primary">Listar</a>
                                    ...
                                    <td  >
                                        ...
                                        <div class="modal fade" id="nuevo2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content col-sm-11 p-0">
                                                    <div class="modal-header mod-h p-3 ">
                                                        <h4 class="modal-title  text-white mt-4 mb-2 ml-3  " id="exampleModalLabel"><i class="fas fa-user"></i> Actualizar Trabajador</h4>
                                                        <div style="border: none" class="close  text-white mr-2" data-dismiss="modal" aria-label="Close">
                                                            &times;
                                                        </div>
