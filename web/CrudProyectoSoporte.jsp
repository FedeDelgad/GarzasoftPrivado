...
<html>
    ...
    <body>     
        <div class=" cuerpo pl-4 pr-4 pt-4 pb-2 " >
            <div class=" d-inline h4 ma-1 pl-2 ">Lista de Proyectos de Soporte</div>
            <a href="controladorproyecto?accion=cargarProSoporte" class="btn text-white float-right btn-1" target="myFrame"><i class="fas fa-plus"></i> Agregar Nuevo</a>
