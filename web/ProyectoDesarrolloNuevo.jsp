                    ...
                    <div class="card-body">
                        <div>
                            <div class="row ml-2 mr-2">
                                <label>Agregue los requerimientos del proyecto</label>
                            </div>
                            <div class="row  d-flex">
                                <div class="form-group col-md-10">
                                    <input name="requerimiento" type="text" class="form-control" placeholder="nombre">
                                </div>
                                <div class="form-group col-md-2">
                                    <button type="submit" name="accion" value="agregarRe" class="btn btn-primary btn-block"
                                            onclick="reque()">Agregar</button>
                                </div>
                            </div>
                        </div>
